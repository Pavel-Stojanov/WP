...
public class ExpensesController {
     ...
     */
    @GetMapping
    public String listAll(@RequestAttribute (required = false) String title,
                          @RequestAttribute (required = false) ExpenseCategory expenseCategory,
                          @RequestAttribute (required = false) Long vendor,
